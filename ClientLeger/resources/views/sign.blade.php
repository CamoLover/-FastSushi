...
<head>
    ...
    <title>FastSushi Connexion</title>
...
.overlay {
	background: #E5383B;
	background: -webkit-linear-gradient(to right, #660708, #E5383B);
	background: linear-gradient(to right, #660708, #E5383B);
	...
	<div class="overlay-container">
		<div class="overlay">
			<div class="overlay-panel overlay-left">
				<h1>Bon retour !</h1>
				<p>Pour rester connecté avec nous, veuillez utiliser vos informations personnelles</p>
