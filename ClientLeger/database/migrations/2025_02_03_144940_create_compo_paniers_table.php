...
return new class extends Migration
{
    ...
    {
        Schema::create('compo_panier', function (Blueprint $table) {
            $table->integer('id_panier_ligne')->unsigned();
            ...
            $table->foreign('id_panier_ligne')->references('id_panier_ligne')->on('Panier_ligne')->onDelete('no action')->onUpdate('no action');
        });
    }
    ...
    {
        Schema::dropIfExists('compo_panier');
    }
};
